...
export const FALLBACK_DEVICES: Device[] = [
  {
    ...
    description: 'Like-new 99% flagship for Apple ProRes Log filming in ads, travel vlogs, and cinematic projects.',
    location: {
      type: 'Point',
    ...
    viewsCount: 24,
    aiAnalysis: {
      summary: 'The iPhone 15 Pro Max is a premium flagship for content creators, delivering cinema-grade Apple Log video quality.',
      pros: ['Cinematic video quality', 'Ultra-light titanium frame', 'Sharp 5x optical zoom camera'],
      cons: ['Glass back can attract fingerprints', 'Gets warm during continuous 4K60 Log filming'],
      rentalRecommendation: 'Ideal for 2-3 day rentals for music videos, events, or travel vlogs.',
    },
  },
  {
    ...
    description: 'Full Galaxy AI toolkit with a bright anti-glare flat screen that excels in outdoor productivity under strong sunlight.',
    location: {
      type: 'Point',
      coordinates: [105.8275, 21.0183],
      address: 'Chua Boc, Dong Da, Hanoi',
    },
    status: 'available',
    rating: 4.8,
    reviewCount: 9,
  ...
  },
  {
    ...
    description: 'One of the best commercial camera kits for weddings, ad shoots, and school or event photography.',
    location: {
      type: 'Point',
      coordinates: [105.7826, 21.0285],
  ...
  },
  {
    ...
    description: 'A premium mobile workstation for 8K editing in Premiere/DaVinci Resolve and 3D rendering in Blender.',
    location: {
      type: 'Point',
      coordinates: [105.8019, 21.0125],
      address: 'Nguyen Trai, Thanh Xuan, Hanoi',
    },
    status: 'available',
    rating: 4.9,
    reviewCount: 18,
  ...
  },
  {
    ...
    description: 'A triple-lens aerial camera system with Hollywood-level video quality and an RC Pro controller with a bright built-in screen.',
    location: {
      type: 'Point',
  ...
  },
  {
    ...
    description: 'A world-class noise-canceling headset perfect for long flights, office focus, or casual audio mixing.',
    location: {
      type: 'Point',
      coordinates: [105.8194, 21.0333],
      address: 'Kim Ma, Ba Dinh, Hanoi',
    },
    status: 'available',
    rating: 4.8,
    reviewCount: 14,
  ...
  },
  {
    ...
    description: 'A heavy-duty gimbal for cinema cameras, including the Focus Motor and RavenEye wireless video transmission kit.',
    location: {
      type: 'Point',
      coordinates: [105.7826, 21.0285],
      address: 'Tran Thai Tong, Cau Giay, Hanoi',
  ...
  },
  {
    ...
    description: 'A high-performance Windows workstation with a 100% DCI-P3 OLED display for professional color work and graphics.',
    location: {
      type: 'Point',
      coordinates: [105.8019, 21.0125],
      address: 'Le Van Luong, Cau Giay, Hanoi',
    },
    status: 'available',
    rating: 4.7,
    reviewCount: 8,
