...
export function MyBookingsScreen({ onNavigateToHome }: MyBookingsScreenProps) {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerTitleRow}>
          ...
          <Text style={styles.headerTitle}>Đơn thuê</Text>
        </View>
        <Text style={styles.headerSubtitle}>
          Theo dõi tiến trình và quản lý các đơn thuê thiết bị
        </Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.description}>
          Bạn chưa có đơn đặt thuê thiết bị nào. Hãy tìm kiếm thiết bị công nghệ bạn cần và đặt thuê ngay nhé!
        </Text>
